 ...
 */
final class Version20220205102834 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE annonce (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, user_id INT NOT NULL, titre VARCHAR(255) NOT NULL, contenu VARCHAR(255) NOT NULL, prix DOUBLE PRECISION NOT NULL, code_postal INT NOT NULL, date_creation DATETIME NOT NULL, photos LONGTEXT DEFAULT NULL, INDEX IDX_F65593E512469DE2 (category_id), INDEX IDX_F65593E5A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
